...
public class StudentMiddleware {
    ...
    public static SignUpResult signup(String fullnameField, String usernameField, String passwordField, String confirmPassword, String phoneField, String emailField) {
        String insert = "INSERT INTO students( name, username, password, email, phone)"
                + "VALUES (?,?,?,?,?)";
        ...
        try {
            ...
            pst.setString(1, fullnameField);
            pst.setString(2, usernameField);
            pst.setString(3, passwordField);
            pst.setString(4, emailField);
            pst.setString(5, phoneField);
